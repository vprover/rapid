...
namespace logic {
    ...
    public:
        ...
        static std::shared_ptr<const FuncTerm> func(std::string name, std::vector<std::shared_ptr<const Term> > subterms, const Sort* sort, bool noDeclaration=false, Symbol::SymbolType typ = Symbol::SymbolType::Other);
