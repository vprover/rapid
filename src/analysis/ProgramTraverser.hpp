...
class ProgramTraverser {
 ...
 private:
  ...
  virtual void generateOutputFor(const program::Assignment* statement,
                                 OutputType& output);
  virtual void generateOutputFor(const program::VarDecl* statement,
                                 OutputType& output);
...
void ProgramTraverser<OutputType>::generateOutputFor(
    const program::Assignment* statement, OutputType& output) {}
template <class OutputType>
void ProgramTraverser<OutputType>::generateOutputFor(
    const program::VarDecl* statement, OutputType& output) {}
template <class OutputType>
void ProgramTraverser<OutputType>::generateOutputFor(
