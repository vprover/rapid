...
class Position {
 public:
  ...
  explicit Position(std::string* f = nullptr, unsigned int l = 1u,
                    unsigned int c = 1u)
      : filename(f), line(l), column(c) {}

  /// Initialization.
  void initialize(std::string* fn = nullptr, unsigned int l = 1u,
                  unsigned int c = 1u) {
    filename = fn;
    line = l;
    column = c;
...
class Location {
 public:
  ...
  /// Initialization.
  void initialize(std::string* f = nullptr, unsigned int l = 1u,
                  unsigned int c = 1u) {
