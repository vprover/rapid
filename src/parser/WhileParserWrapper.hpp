...
/*
 * main method for parsing input. Internally calls the parser autogenerated by
 * Flex and Bison.
 */
WhileParserResult parse(std::string inputFile) {
  ...
  return WhileParserResult(
      std::move(context.program), std::move(context.locationToActiveVars),
